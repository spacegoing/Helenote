 ...
 */
public class LabelNoteActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView = (ListView) findViewById(R.id.label_note_listview);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (cursor != null) {
                    Intent intent = new Intent(LabelNoteActivity.this, DetailNoteActivity.class)
                            .setData(
    ...
    public void filtNoteByLabel(View view) {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        EditText editText = (EditText) findViewById(R.id.label_input);
        String label = editText.getText().toString();

        Uri NotesUri = NotesContract.NoteEntry.buildNoteWithLabel(label);
